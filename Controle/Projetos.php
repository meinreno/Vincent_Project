<?php
	...
	if ($informacoes[0] == 'salvarEditarProjeto') {
		$editarProjeto = new ProjetoTools;
		$editarProjeto->salvarEditarProjeto($informacoes[1], $informacoes[2]['value'], $informacoes[3]['value'], $informacoes[4]['value'], $informacoes[5]['value'], $informacoes[6]['value'], $informacoes[7]['value'], $informacoes[8]['value'], $informacoes[9]['value'], $informacoes[10]['value'], $informacoes[11]['value'], $informacoes[12]['value'], $informacoes[13]['value'], $informacoes[14]['value'], $informacoes[15]['value'], $informacoes[16]['value'], $informacoes[17]['value'], $informacoes[18]['value'], $informacoes[19]['value'], $informacoes[20]['value'], $informacoes[21]['value']);
	}
